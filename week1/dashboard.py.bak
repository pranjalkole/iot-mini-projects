...
# path of the data
data_path = "bstation/data/sensor_data.csv"
...
def load_csv_data(csv_path=data_path):
...
with st.sidebar:
    ...
    # CSV file selector
    csv_path = st.text_input("CSV File Path", value=data_path, help="Path to the CSV file containing sensor data")
